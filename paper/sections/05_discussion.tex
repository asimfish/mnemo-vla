...
The toy \texttt{HashingEmbedder} that ships with v0.1 provides only
modest retrieval quality. Production deployments should replace it
with a sentence transformer or the text encoder of the underlying
VLA. We document the substitution clearly and ship the Sentence
Transformer variant as an optional dependency.
